...
path = r"C:\Users\ericluo04\Desktop\Yale Files\2019-2020 Files of Yale\S&DS 491\1. HK Dataset\Query_twitter_data-master\HK English\HK English.db"
...
for table_name in tables:
    ...
    with open(table_name['name']+'.json', 'a', encoding="utf-8") as the_file:

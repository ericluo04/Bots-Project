...
- I recommend using search.py. Be sure to change the date ranges in the python code appropriately. A free developer account only lets you scrape back seven days, so run this code (with the updated date ranges) weekly. 
